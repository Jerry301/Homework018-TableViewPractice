...
class ActTableViewController: UITableViewController {
    
    
    @IBSegueAction func detailSegue(_ coder: NSCoder) -> ActDetailViewController? {
        
        
        if let section = tableView.indexPathForSelectedRow?.section, let row = tableView.indexPathForSelectedRow?.row {
            return ActDetailViewController(coder: coder, program: acts[section].program[row])
                } else {
                    return nil
                }
            }
...
//            return ActDetailViewController(coder: coder, program: acts[row])
//        } else {
//            return nil
//        }
//    }
//
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = acts[indexPath.section].program[indexPath.row].name
        cell.detailTextLabel?.text = acts[indexPath.section].program[indexPath.row].intro
        cell.imageView?.image = UIImage(named: acts[indexPath.section].program[indexPath.row].actImage)
        
//        let act = acts[indexPath.row]
//
//        cell.textLabel?.text = act.name
//        cell.detailTextLabel?.text = act.intro
//        cell.imageView?.image = UIImage(named: act.actImage)
//
